In App.vue, there are two textboxes defined for you. They are for the user to enter the width and height of a rectangle. There is a `<div>` with the id of "result" too.
